  ...
  return (
    <div className="min-h-screen relative">
      ...
      <div className="absolute inset-0 flex items-center justify-center bg-black/70">
        <div
          className={`p-20 rounded-2xl shadow-lg text-left space-y-8 w-150 ${glassBg} justify-center items-center align-center flex flex-col`}
          style={{ paddingBottom: 20, paddingTop: 25 }}
        >
          <div style={{ height: 10 }}></div>
          <LogoHeading size={4} />
          <p
            className="text-white text-lg font-medium m-0"
            style={{
              fontWeight: 300,
              fontSize: "1.5rem",
              lineHeight: "2rem",
