...
const PlayerPage = ({ params }) => {
  ...
  return (
    <div className="min-h-screen pt-20 bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 text-gray-200 relative">
      ...
      <div className="relative z-20 -mt-4 sm:-mt-16 lg:-mt-20 px-4 sm:px-6">
        <div className="max-w-4xl mx-auto bg-gray-900/80 backdrop-blur-lg rounded-xl p-4 sm:p-6 flex flex-col lg:flex-row items-center lg:items-start gap-4 sm:gap-6">
          ...
          <div className="flex flex-wrap gap-3 sm:gap-4 mb-4 sm:mb-6">
            <div>
              ...
              <select
                ...
                className="bg-gray-800 text-white px-3 py-2 rounded-md border border-gray-700 focus:outline-none text-sm"
              >
      ...
      <main className="container mx-auto px-4 md:px-6 py-8 sm:py-12 bg-pattern relative z-10">
        ...
        {player?.best_game && (
          <section className="mb-16">
            ...
            <div className="bg-gray-800/60 p-4 sm:p-6 rounded-lg flex flex-col md:flex-row items-center">
