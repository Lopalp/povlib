...
const Navbar = ({
  ...
  return (
    <header className={`fixed top-0 w-full z-50 transition-all duration-300 ${isScrolled ? 'bg-opacity-50 backdrop-filter backdrop-blur-lg shadow-xl bg-gradient-to-b from-black/50 to-transparent border-b border-gray-700' : ''}`}>
