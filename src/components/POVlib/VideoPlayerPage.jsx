                  ...
                  <div className="md:w-2/3">
                    ...
                    <div className="flex flex-col md:flex-row gap-6 mb-6">
                      ...
                      <div className="md:w-1/2 bg-gradient-to-br from-gray-800 to-gray-850 rounded-lg p-4 border border-gray-700">
                        ...
                        <div className="space-y-2 text-xs">
                          <button className="bg-gray-700 text-white font-bold py-1 px-3 rounded hover:bg-gray-600 transition-colors w-full flex items-center justify-between">
                    ...
                    <div className="bg-gradient-to-br from-gray-800 to-gray-850 rounded-lg p-4 mb-6 border border-gray-700">
                      <div className="flex flex-wrap gap-2 mb-4">
                        ...
                        {selectedDemo.team && <span className="bg-gray-700 text-sm px-3 py-1 rounded">{selectedDemo.team}</span>}
                        {selectedDemo.event && <span className="bg-gray-700 text-sm px-3 py-1 rounded">{selectedDemo.event}</span>}
                    ...
                    <div className="mt-4 pt-4 border-t border-gray-700">
                      ...
                      <Link href={`/?map=${selectedDemo.map}`}>
                        <a className="text-sm bg-gray-700 hover:bg-yellow-400 hover:text-gray-900 px-3 py-2 rounded w-full flex items-center justify-between">
            ...
            <div className="lg:w-4/12 mt-6 lg:mt-0">
              <div className="bg-gradient-to-br from-gray-800 to-gray-850 rounded-lg p-4 border border-gray-700">
                ...
                <div className="space-y-4">
                  {relatedDemos.length > 0 ? relatedDemos.map(demo => (
                    <div 
                      key={demo.id} 
                    ...
                    >
                      ...
                      <div className="flex-1">
                        ...
                        <div className="text-gray-400 text-xs mt-1">{demo.players.join(', ')}</div>
                ...
                <div className="mt-6 pt-4 border-t border-gray-700">
                  ...
                  <div className="grid grid-cols-2 gap-2">
                    {selectedDemo.players[0] && (
                      <Link href={`/players/${selectedDemo.players[0].replace(/\s+/g, '-').toLowerCase()}`}>
                        <a className="bg-gray-700 hover:bg-yellow-400 hover:text-gray-900 text-white text-sm py-2 px-3 rounded text-center transition-colors">
                          {selectedDemo.players[0]}'s POVs
                        </a>
                      </Link>
                    )}
                    {selectedDemo.map && (
                    ...
                    {selectedDemo.positions?.[0] && (
                      <Link href={`/?position=${selectedDemo.positions[0]}`}>
                        <a className="bg-gray-700 hover:bg-yellow-400 hover:text-gray-900 text-white text-sm py-2 px-3 rounded text-center transition-colors">
                    ...
                    {selectedDemo.team && (
                      <Link href={`/?team=${selectedDemo.team}`}>
                        <a className="bg-gray-700 hover:bg-yellow-400 hover:text-gray-900 text-white text-sm py-2 px-3 rounded text-center transition-colors">
