...
const UserQuestionModule = ({ mode, useCase, onSubmit }) => {
  ...
  const useCaseConfig = {
      ...
      surveyTabs: [
        {
          ...
          label: 'Allgemein',
          fields: [
            { name: 'erwartungen', label: 'Was erwartest du von der App?', type: 'text' },
            { name: 'zufriedenheit', label: 'Wie zufrieden bist du (1–5)?', type: 'number' },
          ],
        },
        {
          key: 'bugs',
          label: 'Bugs & Probleme',
          fields: [
            { name: 'gefunden', label: 'Hast du Bugs gefunden?', type: 'radio', options: ['Ja', 'Nein'] },
            { name: 'bugBeschreibung', label: 'Beschreibe den Bug', type: 'textarea' },
          ],
        },
      ],
      singleQuestion: {
      ...
      surveyTabs: [
        {
          ...
          fields: [
            { name: 'kategorie', label: 'Kategorie wählen', type: 'select', options: ['Technisch', 'Abrechnung', 'Sonstiges'] },
            { name: 'priorität', label: 'Dringlichkeit', type: 'radio', options: ['Hoch', 'Mittel', 'Niedrig'] },
          ],
        },
        {
          key: 'details',
          label: 'Details',
          fields: [
            { name: 'beschreibung', label: 'Beschreibe dein Problem', type: 'textarea' },
            { name: 'anhang', label: 'Screenshot (optional)', type: 'file' },
          ],
        },
      ],
      singleQuestion: {
        questionText: 'Handelt es sich um ein wiederkehrendes Problem? (Ja/Nein)',
        type: 'radio',
        options: ['Ja', 'Nein'],
      },
    },
    profile: {
      ...
      description: 'Ergänze dein Profil, damit wir dich besser unterstützen können.',
      surveyTabs: [
        {
          key: 'personal',
          label: 'Persönlich',
        ...
        },
        {
          ...
          fields: [
            ...
            { name: 'fachgebiete', label: 'Fachgebiete', type: 'select', options: ['Design', 'Entwicklung', 'Marketing', 'Management'] },
          ],
        },
      ],
      singleQuestion: {
    ...
    <>
      <div className="bg-gray-900 rounded-2xl p-8 shadow-lg">
        <div className="flex justify-between items-center mb-4">
          ...
          <button onClick={() => setIsSurveyOpen(true)} className="text-gray-400 hover:text-gray-200">
        ...
        {mode === 'survey' ? (
          ...
          <div className="space-y-4">
            <label className="block text-gray-200 font-medium">{cfg.singleQuestion.questionText}</label>
