...
const PlayersIndex = () => {
  ...
  useEffect(() => {
    const loadPlayers = async () => {
      try {
        ...
        const playersData = await getAllPlayers(demoType, 1, 20, filtersApplied);
        if (!playersData) {
          setPlayers([]);
          setFilteredPlayers([]);
          setHasMore(false);
  ...
  const loadMorePlayers = async () => {
    ...
    try {
      ...
      const playersData = await getAllPlayers(demoType, nextPage, 20, filtersApplied);
    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-700 via-gray-800 to-gray-900 text-gray-200">
      ...
      <div className="relative py-16 bg-gradient-to-b from-gray-800 to-gray-900">
        ...
        <div className="container mx-auto px-6 text-center">
          <h1 className="text-4xl md:text-5xl font-bold mb-4 text-white">CS2 Pro Players</h1>
          <p className="text-gray-300 max-w-2xl mx-auto mb-8">
            Browse all professional CS2 players and their POV demos. Watch and learn from the best players in the world.
          </p>
      ...
      <main className="container mx-auto px-6 py-12">
        ...
        {filtersApplied.team && (
          <div className="mb-8 flex items-center">
            ...
            <div className="bg-gray-800 px-3 py-1 rounded-full text-yellow-400 text-sm font-medium flex items-center">
              ...
              <button 
                onClick={() => setFiltersApplied(prev => ({ ...prev, team: '' }))}
        ...
        {filteredPlayers.length > 0 ? (
          ...
          <div className="flex flex-col items-center justify-center h-64 bg-gray-800/50 rounded-xl border border-gray-700">
            ...
            <h3 className="text-white text-xl font-bold mb-2">No players found</h3>
        ...
        {!hasMore && players.length > 0 && (
          <div className="text-center my-12 py-6 border-t border-gray-800">
            <p className="text-gray-400">You've reached the end of the players list</p>
          </div>
        )}
      </main>
