...
const FeaturedHero = ({
  ...
  return (
    <div className="relative w-full aspect-video overflow-hidden bg-gradient-to-br from-gray-800 to-gray-900 group">
      ...
      <div className="relative z-20 container mx-auto h-full flex items-center px-6">
        ...
        >
          ...
          {/* Tags (einheitlicher Stil) */}
          <div className="flex flex-wrap gap-2 mb-4">
            {/* Map-Tag als Highlight */}
          ...
          {/* Buttons: auf xs nur Icon-Button, ab sm mit Text */}
          <div className="flex items-center gap-4">
            <button
              ...
              className="flex items-center justify-center sm:justify-start gap-2 px-3 sm:px-6 py-2 bg-yellow-400 text-gray-900 font-bold rounded-md 
                         shadow-[0_0_15px_rgba(250,204,21,0.5)] transition-transform transform hover:scale-105"
            >
            ...
            <button
              ...
              className="hidden sm:flex items-center gap-2 px-4 py-2 bg-gray-800/40 backdrop-blur-sm text-white rounded-md border border-gray-700 
