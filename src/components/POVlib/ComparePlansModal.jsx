...
const ComparePlansModal = ({ isOpen, onClose, onSelectPlan, currentPlan }) => {
  ...
  // Utility-Funktion, um die Button-Beschriftung anzupassen
  const renderButton = (planKey, priceLabel) => {
    ...
    return (
      ...
      >
        {planKey === 'standard' ? `Jetzt für ${priceLabel}` : `Aktivieren für ${priceLabel}`}
      </button>
    );
  };
  ...
  return (
    ...
    >
      <div className="bg-black/40 backdrop-blur-lg border border-gray-700 rounded-xl max-w-3xl w-full overflow-y-auto shadow-[0_0_30px_rgba(250,204,21,0.15)]">
        {/* Header */}
            ...
            <div className="border border-gray-700 rounded-lg p-6 flex flex-col justify-between">
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  <li>3 Credits / Monat</li>
                  <li>Grundlegendes Utility Book</li>
                  <li>Standard‐Verarbeitung</li>
            ...
            <div className="relative bg-yellow-400 rounded-lg p-6 flex flex-col justify-between shadow-lg ring-2 ring-yellow-300">
              ...
              <div className="">
                ...
                <ul className="space-y-2 text-gray-900">
                  <li>5 Credits / Monat +50 % mehr</li>
                  <li>Volles Utility Book</li>
            ...
            <div className="border border-gray-700 rounded-lg p-6 flex flex-col justify-between">
              <div>
                ...
                <ul className="space-y-2 text-gray-400">
                  ...
                  <li>Vollständiges Utility Book + Exklusive Kapitel</li>
                  <li>Express‐Verarbeitung</li>
                  <li>Priority‐Support 24/7</li>
                  <li>Exklusive Early‐Access‐Demos</li>
                </ul>
                <p className="mt-2 text-sm text-gray-400 italic">
                  Ideal für Profis & Teams
                </p>
              </div>
